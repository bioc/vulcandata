...
vulcansheet<-function(outfile="sheetfile.csv"){
    ...
    row1<-c("T90_1","MCF7","ER","t90","1",
            system.file("extdata","A90_I.bam",package="vulcandata",mustWork=TRUE),
            system.file("extdata","A90_peaks.bed.gz",package="vulcandata",
                        mustWork=TRUE),"bed"
    )
    row2<-c("T90_2","MCF7","ER","t90","2",
            system.file("extdata","B90_I.bam",package="vulcandata",mustWork=TRUE),
            system.file("extdata","B90_peaks.bed.gz",package="vulcandata",
                        mustWork=TRUE),"bed"
    )
    row3<-c("T90_3","MCF7","ER","t90","3",
            system.file("extdata","C90_I.bam",package="vulcandata",mustWork=TRUE),
    ...
    row6<-c("T45_2","MCF7","ER","t45","2",
            system.file("extdata","B45_I.bam",package="vulcandata",mustWork=TRUE),
            system.file("extdata","B45_peaks.bed.gz",package="vulcandata",
                        mustWork=TRUE),"bed"
    )
    row7<-c("T45_3","MCF7","ER","t45","3",
            system.file("extdata","C45_I.bam",package="vulcandata",mustWork=TRUE),
    ...
    row10<-c("T0_2","MCF7","ER","t0","2",
            system.file("extdata","B0_I.bam",package="vulcandata",mustWork=TRUE),
            system.file("extdata","B0_peaks.bed.gz",package="vulcandata",
                        mustWork=TRUE),"bed"
    )
    row11<-c("T0_3","MCF7","ER","t0","3",
            system.file("extdata","C0_I.bam",package="vulcandata",mustWork=TRUE),
